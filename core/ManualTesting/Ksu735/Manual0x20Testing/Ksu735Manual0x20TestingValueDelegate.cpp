...
Ksu735Manual0x20TestingValueDelegate::Ksu735Manual0x20TestingValueDelegate(Ksu735Manual0x20TestingModel *model, QObject *parent) :
...
void Ksu735Manual0x20TestingValueDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
...
QWidget *Ksu735Manual0x20TestingValueDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    Q_UNUSED(option)
...
void Ksu735Manual0x20TestingValueDelegate::setEditorData(QWidget *editor, const QModelIndex &index) const
{
    Ksu735Manual0x20TestingParametr *parametr = m_model->parametrByIndex(index);
    if (parametr && parametr->variable && parametr->variable->format() == SapKsu::CCCC) {
...
void Ksu735Manual0x20TestingValueDelegate::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index) const
{
    Ksu735Manual0x20TestingParametr *parametr = m_model->parametrByIndex(index);
    if (parametr && parametr->variable && parametr->variable->format() == SapKsu::CCCC ) {
        QLineEdit *lineEdit = qobject_cast<QLineEdit *>(editor);
