#include "ModbusArchivesEventClasses.h"
...
ModbusArchivesEventClasses::ModbusArchivesEventClasses(int comProtocolCode, QWidget *parent) :
    QWidget(parent),
    m_comProtocolCode(comProtocolCode)
{
    ...
    m_view = new CustomizableTableView("ModbusArchivesEventClasses");
    ...
    connect(m_view, &QTableView::doubleClicked, this, &ModbusArchivesEventClasses::edit);
    ...
    connect(m_addButon, &PushButtonPlus::clicked, this, &ModbusArchivesEventClasses::add);
    connect(m_removeButton, &PushButtonPlus::clicked, this, &ModbusArchivesEventClasses::remove);
...
void ModbusArchivesEventClasses::add()
{
    ModbusArchivesEventClassesDialogMapper *mapper = new ModbusArchivesEventClassesDialogMapper(m_comProtocolCode,
                                                                                                m_model);
    connect(mapper,     &ModbusArchivesEventClassesDialogMapper::dataChanged,
            this,       &ModbusArchivesEventClasses::selectData);
...
void ModbusArchivesEventClasses::remove()
{
    ...
    QString msgString = QString("\"Класс события\" = %1(%2)")
    ...
    if (msgBox.clickedButton() == yesButton) {
        ...
        QString sqlString = QString("DELETE FROM `ModbusArchivesEventClasses`"
...
void ModbusArchivesEventClasses::edit()
{
    ModbusArchivesEventClassesDialogMapper *mapper = new ModbusArchivesEventClassesDialogMapper(m_comProtocolCode,
                                                                                                m_model);
    connect(mapper,     &ModbusArchivesEventClassesDialogMapper::dataChanged,
...
void ModbusArchivesEventClasses::selectData()
{
    QSqlDatabase db = DBConfig::instance()->configDatabase();
    QString sqlString = QString("SELECT * FROM `ModbusArchivesEventClasses`"
    ...
    m_model->setHeaderData(1, Qt::Horizontal, tr("Класс события"));
