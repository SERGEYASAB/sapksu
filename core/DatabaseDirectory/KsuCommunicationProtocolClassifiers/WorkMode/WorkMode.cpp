...
WorkMode::WorkMode(int comProtocolCode, QWidget *parent) : QWidget(parent)
{
    ...
    m_view = new CustomizableTableView("WorkMode");
    ...
    connect(m_view, &QTableView::doubleClicked, this, &WorkMode::edit);
    ...
    connect(m_addButon, &PushButtonPlus::clicked, this, &WorkMode::add);
    connect(m_removeButton, &PushButtonPlus::clicked, this, &WorkMode::remove);
...
void WorkMode::edit()
{
    WorkModeDialogMapper *mapper = new WorkModeDialogMapper(m_comProtocolCode, m_model);
    connect(mapper, &WorkModeDialogMapper::dataChanged, this, &WorkMode::selectData);
...
void WorkMode::remove()
{
    ...
    if (msgBox.clickedButton() == yesButton) {
        ...
        QString sqlString = QString("DELETE FROM `WorkMode`"
