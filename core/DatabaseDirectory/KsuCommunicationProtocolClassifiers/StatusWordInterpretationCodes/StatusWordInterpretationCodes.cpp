#include "StatusWordInterpretationCodes.h"

#include "DBConfig/DBConfig.h"
#include "Common/PushButtonPlus.h"
#include "StatusWordDialogMapper.h"
...
StatusWordInterpretationCodes::StatusWordInterpretationCodes(int comProtocolCode, QWidget *parent)
{
    ...
    m_view = new CustomizableTableView("StatusWordInterpretationCodes");
    ...
    connect(m_view, &QTableView::doubleClicked, this, &StatusWordInterpretationCodes::edit);
    ...
    connect(m_addButon, &PushButtonPlus::clicked, this, &StatusWordInterpretationCodes::add);
    connect(m_removeButton, &PushButtonPlus::clicked, this, &StatusWordInterpretationCodes::remove);
...
void StatusWordInterpretationCodes::add()
{
    StatusWordDialogMapper *mapper = new StatusWordDialogMapper(m_comProtocolCode, m_model);
    connect(mapper, &StatusWordDialogMapper::dataChanged, this, &StatusWordInterpretationCodes::selectData);
...
void StatusWordInterpretationCodes::remove()
{
    ...
    if (msgBox.clickedButton() == yesButton) {
        ...
        QString sqlString = QString("DELETE FROM `StatusWordInterpretationCodes`"
...
void StatusWordInterpretationCodes::edit()
{
    StatusWordDialogMapper *mapper = new StatusWordDialogMapper(m_comProtocolCode, m_model);
    connect(mapper, &StatusWordDialogMapper::dataChanged, this, &StatusWordInterpretationCodes::selectData);
    mapper->setAttribute(Qt::WA_DeleteOnClose, true);
...
void StatusWordInterpretationCodes::selectData()
{
    QSqlDatabase db = DBConfig::instance()->configDatabase();
    QString sqlString = QString("SELECT * FROM `StatusWordInterpretationCodes`"
