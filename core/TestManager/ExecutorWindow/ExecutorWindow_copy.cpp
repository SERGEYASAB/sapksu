...
ExecutorWindow_copy::ExecutorWindow_copy(const QList<ITest *> &tests, QWidget *parent)
    : QMainWindow(parent),
      m_tests(tests)
{
    setupToolBar();
...
ExecutorWindow_copy::~ExecutorWindow_copy()
{
...
ITest *ExecutorWindow_copy::currentTest() const
{
    return m_currentTest;
}

void ExecutorWindow_copy::setCurrentTest(ITest *currentTest)
{
    ...
    if (m_currentTest != nullptr) {
        ...
        disconnect(m_currentTest, &ITest::messageChanged, this, &ExecutorWindow_copy::logMessage);
        disconnect(m_currentTest, &ITest::currentStepChanged, this, &ExecutorWindow_copy::updateStepListWidget);
        disconnect(m_currentTest, &ITest::currentTestDeinitAndGoNext, this, &ExecutorWindow_copy::goNextTest);
    }

    m_currentTest = currentTest;

    connect(currentTest, &ITest::messageChanged, this, &ExecutorWindow_copy::logMessage);
    connect(currentTest, &ITest::currentStepChanged, this, &ExecutorWindow_copy::updateStepListWidget);
    connect(currentTest, &ITest::currentTestDeinitAndGoNext, this, &ExecutorWindow_copy::goNextTest);
...
void ExecutorWindow_copy::setupTestListDockWidget()
{
...
void ExecutorWindow_copy::setupStepListDockWidget()
{
...
void ExecutorWindow_copy::setupTextProgramWidget()
{
...
void ExecutorWindow_copy::setupLoggerOutputWidget()
{
...
void ExecutorWindow_copy::setupExtVarDockWidget()
{
...
void ExecutorWindow_copy::setupKsuVarDockWidget()
{
...
void ExecutorWindow_copy::setupIntVarDockWidget()
{
...
void ExecutorWindow_copy::setupToolBar()
{
    ...
    connect(runAllTestAction, &QAction::triggered, this, &ExecutorWindow_copy::runAllTests);
    ...
    connect(runTestAction, &QAction::triggered, this, &ExecutorWindow_copy::runCurrentTest);
    ...
    connect(runStepAndGoNextAction, &QAction::triggered, this, &ExecutorWindow_copy::runCurrentStepAndGoNext);
    ...
    connect(runStepRetryAction, &QAction::triggered, this, &ExecutorWindow_copy::runCurrentStep);
    ...
    connect(restartTestingAction, &QAction::triggered, this, &ExecutorWindow_copy::restartTestingPrepare);
    ...
    connect(showReportAction, &QAction::triggered, this, &ExecutorWindow_copy::showReportWindow);
    ...
    connect(previewReportAction, &QAction::triggered, this, &ExecutorWindow_copy::previewReportWindow);
    ...
    connect(pdfAction, &QAction::triggered, this, &ExecutorWindow_copy::printToPdf);
    ...
    connect(sendPauseAction, &QAction::triggered, this, &ExecutorWindow_copy::sendPause);
    ...
    connect(sendContinueAction, &QAction::triggered, this, &ExecutorWindow_copy::sendContinue);
...
void ExecutorWindow_copy::setupLogDockWidget()
{
...
void ExecutorWindow_copy::updateTestListWidget(ITest *currentTest)
{
    m_testListWidget->setCurrentRow(m_tests.indexOf(currentTest));
}

void ExecutorWindow_copy::updateStepListWidget(ITestStep *currentStep)
{
    m_stepListWidget->setCurrentRow(currentTest()->steps().indexOf(currentStep));
    updateProgramWidget(currentStep);
}

void ExecutorWindow_copy::updateProgramWidget(ITestStep *currentStep)
{
    m_textProgramWidget->setPlainText(currentStep->textProgram());
}

void ExecutorWindow_copy::readSettings()
{
...
void ExecutorWindow_copy::setupMainWindowSettings()
{
...
bool ExecutorWindow_copy::checkPressContinue()
{
...
void ExecutorWindow_copy::sendPause()
{
        qDebug()<<"pause";
...
void ExecutorWindow_copy::sendContinue()
{
...
void ExecutorWindow_copy::fillTestListWidget()
{
    if (m_tests.isEmpty())
        return;
...
void ExecutorWindow_copy::fillStepListWidget()
{
...
void ExecutorWindow_copy::fillVarTableWidgets()
{
    if (currentTest()) {
...
bool ExecutorWindow_copy::runStep(int stepNumber)
{
    if (currentTest()) {
...
void ExecutorWindow_copy::runStepAndGoNext(int stepNumber)
{
    if (currentTest())
        currentTest()->runStepAndGoNext(stepNumber);
}

void ExecutorWindow_copy::goNextTest()
{
...
void ExecutorWindow_copy::runCurrentStep()
{
    qDebug() << "Сделать один шаг";
...
void ExecutorWindow_copy::runCurrentStepAndGoNext()
{
    if (checkPressContinue())
        return;
...
void ExecutorWindow_copy::runCurrentTest()
{
...
void ExecutorWindow_copy::runAllTests()
{
...
void ExecutorWindow_copy::runCurrenTestBeforeStepNumber(int stepNumber)
{
    if (checkPressContinue() || !currentTest())
        return;
...
void ExecutorWindow_copy::executeTest(ITest *test)
{

}

void ExecutorWindow_copy::logMessage(const QString &message)
{
    m_logTextEdit->append(message);
}

void ExecutorWindow_copy::showReportWindow()
{
    QDateTime to = QDateTime::currentDateTime();
    m_reportConfig->showReport(ReportConfigure::TestHistoryReport, m_beginDate, to);
}

void ExecutorWindow_copy::previewReportWindow()
{
    QDateTime to = QDateTime::currentDateTime();
    m_reportConfig->previewReport(ReportConfigure::TestHistoryReport, m_beginDate, to);
}

void ExecutorWindow_copy::printToPdf()
{
    QDateTime to = QDateTime::currentDateTime();
    m_reportConfig->printToPdfReport(ReportConfigure::TestHistoryReport, m_beginDate, to);
}

void ExecutorWindow_copy::closeEvent(QCloseEvent *event)
{
    auto settings = AppSettings::settings();
...
void ExecutorWindow_copy::restartTestingPrepare()
{
...
//void ExecutorWindow_copy::playThisStep()
//{
//    const QIcon runStepAndGoNextIcon = QIcon(":/Images/media-skip-forward.png");
//    QAction *runStepAndGoNextAction = new QAction(runStepAndGoNextIcon,
//                                                  tr("&Выполнить текущий шаг и перейти к следующему"), this);
